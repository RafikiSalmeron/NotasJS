...
function cargarNotas(nota){
	...
	divcerrar.appendChild(dive);
	 ...
	 notas.push(new Nota(id, nota.titulo, nota.texto, "FECHA"));
...
function confirmar(){
	if (notaE !== null){
		...
		notas.push(new Nota(id, titulo, texto, "FECHA"));
		localStorage.setItem("notas", JSON.stringify(notas));
		console.log("id : " + id);
